...
Striae is currently in **Beta** (v0.9.24) with active development featuring a complete authenticated confirmation system and comprehensive audit logging. The release candidate is expected to deploy on October 1, 2025. The project is actively maintained and welcomes contributions from the forensic technology community.
