...
* OSAC - <a target="_blank" href="https://www.nist.gov/osac/standards-library">Organization of Scientific Area Committees (OSAC) Forensic Science Standards Library</a>

  ISO/IEC 17025 - <a target="_blank" href="https://www.iso.org/standard/66912.html">ISO/IEC 17025 – General requirements for the competence of testing and calibration laboratories (official text)</a>

* Official specification for AES encryption- [NIST Advanced Encryption Standard (AES)](https://www.nist.gov/publications/advanced-encryption-standard-aes)

* Federal approval and technical specifications for AES- [NIST FIPS 197](https://csrc.nist.gov/publications/detail/fips/197/final)

* Comprehensive security and compliance information- [Cloudflare Trust Hub](https://www.cloudflare.com/trust-hub/)

* Industry certifications and compliance documentation- [Cloudflare Compliance Resources](https://www.cloudflare.com/trust-hub/compliance-resources/)
