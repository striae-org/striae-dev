...
export const meta = () => {
  return baseMeta({
    title: 'License & Terms | Striae',
    description: 'License & Terms and Conditions for Use, Reproduction, and Distribution',
  });
};
...
export const License = () => {
  return (
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <p className={styles.lastUpdated}>Version 2.0, January 2004</p>
        <p><a href="http://www.apache.org/licenses/" target="_blank" rel="noopener noreferrer" >http://www.apache.org/licenses/</a></p>
  ...
  <ol>
    ...
    <li><p><strong>Grant of Copyright License.</strong></p><p>Subject to the terms and conditions of this License, each Contributor hereby grants to You a perpetual,
      worldwide, non-exclusive, no-charge, royalty-free, irrevocable copyright license to reproduce, prepare 
      Derivative Works of, publicly display, publicly perform, sublicense, and distribute the Work and such 
      Derivative Works in Source or Object form.</p></li>
      <li><p><strong>Grant of Patent License.</strong></p>
      <p>Subject to the terms and conditions of this License, each Contributor hereby grants to You a perpetual,
      worldwide, non-exclusive, no-charge, royalty-free, irrevocable (except as stated in this section) patent 
      license to make, have made, use, offer to sell, sell, import, and otherwise transfer the Work...</p></li>
      <li>
      ...
      with or without modifications, and in Source or Object form, provided that You meet the following conditions:</p>
      <ol>
      ...
      <li><p><strong>Submission of Contributions.</strong></p> Unless You explicitly state otherwise,
      ...
      <li><p><strong>Trademarks.</strong></p> This License does not grant permission to use the trade
      names, trademarks, service marks, or product names of the Licensor,
      except as required for reasonable and customary use in describing the
      origin of the Work and reproducing the content of the NOTICE file.
</li>
<li><p><strong>Disclaimer of Warranty.</strong></p> Unless required by applicable law or
...
<li><p><strong>Limitation of Liability.</strong></p>In no event and under no legal theory,
      ...
      <li><p><strong>Accepting Warranty or Additional Liability.</strong></p>While redistributing
  ...
  <div className={styles.copyright}>
    <p>Copyright © 2025 AllyForensics & Stephen J. Lu</p>
