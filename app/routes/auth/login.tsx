                    ...
                    >
                      {showPassword ? (
                        <svg width="24" height="24" viewBox="0 0 24 24">
                          <path d="M12 6c3.98 0 7.88 2.35 9.54 6-1.09 2.29-3.05 4.1-5.45 4.83l1.46 1.46c2.97-1.13 5.22-3.66 6.12-6.56C21.13 7.67 16.84 4.5 12 4.5c-1.43 0-2.8.19-4.1.54l1.45 1.45C10.13 6.08 11.04 6 12 6zm10.54 12.88l-1.41 1.41-1.44-1.44C17.11 19.6 14.66 21 12 21c-5.25 0-9.45-3.28-11-7.5 1.03-2.63 3-4.81 5.56-6.2l-1.42-1.42 1.41-1.41 18 18z"/>
                        </svg>
                      ) : (
                        <svg width="24" height="24" viewBox="0 0 24 24">
                          <path d="M12,4.5C7,4.5,2.73,7.61,1,12c1.73,4.39,6,7.5,11,7.5s9.27-3.11,11-7.5C21.27,7.61,17,4.5,12,4.5z M12,17c-2.76,0-5-2.24-5-5s2.24-5,5-5s5,2.24,5,5S14.76,17,12,17z"/>
