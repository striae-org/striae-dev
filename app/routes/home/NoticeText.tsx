...
const NoticeText = () => {
  ...
  return (
    <div>
      ...
      <p>
        We are excited to announce Striae, an innovative web app designed to assist firearms examiners in creating detailed annotations for your comparison images. Striae aims to streamline the processes of labeling, note-taking, and printing, making the review process a little bit easier. <strong><Link to="https://help.striae.org/striae-users-guide/getting-started/where-does-striae-fit">Where does Striae fit into your workflow?</Link></strong>
      </p>
