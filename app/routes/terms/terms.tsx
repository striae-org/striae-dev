...
export const meta = () => {
  return baseMeta({
    ...
    description: 'Terms & Conditions for Using Striae.',
  });
};
...
<p><strong>Fees:</strong> Striae is provided free of charge for all eligible users.</p>
...
<p>The Company reserves the right, but not the obligation, to, in its sole discretion, determine whether or not any Data is appropriate and complies with these Terms, refuse or remove this Data. The Company can also limit or revoke the use of the Service if You submit such objectionable Data.</p>
<h3>Data Integrity</h3>
<p>The Company will not edit, alter, or modify Your Data in any shape or form. The role of Striae is to store, display, and make Your Data accessible to You, but the content remains entirely under Your control.</p>
<h3>Data Backups</h3>
<p>The Company does not perform backups. The Company does not guarantee there will be no loss or corruption of existing Data.</p>
<p>Corrupt or invalid Data uploads may be caused by, without limitation, Data that is corrupted prior to being uploaded or that changes during the time an upload is performed.</p>
<p>The Company will provide support and attempt to troubleshoot any known or discovered issues that may affect Data. But You acknowledge that the Company has no liability related to the integrity of Data or the failure to successfully restore Data to a usable state.</p>
