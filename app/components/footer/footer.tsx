    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <p className={styles.copyright}>
          <Link to="https://github.com/striae-org/striae/blob/master/LICENSE" className={styles.link} target="_blank" rel="noopener noreferrer">Striae v0.9.06-beta</Link> © {year}. All rights reserved.
          <br />
