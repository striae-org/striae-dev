    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <p className={styles.copyright}>
          <a href={`https://github.com/striae-org/striae/releases/tag/v${appVersion}-beta`} className={styles.link} target="_blank" rel="noopener noreferrer">Striae {appVersion}</a> © {year}. All rights reserved.
          <br />
