                  ...
                  getFilteredEntries().map((entry, index) => (
                    <div key={index} className={`${styles.entry} ${styles[entry.result]}`}>
                      ...
                      <div className={styles.entryDetails}>
                        ...
                        {(entry.action === 'file-upload' || entry.action === 'file-delete' || entry.action === 'file-access' || entry.action === 'pdf-generate' || entry.action === 'confirm') && entry.details.fileDetails && (
                          <>
                            {/* File ID */}
                        ...
                        {(entry.action === 'pdf-generate' || entry.action === 'confirm') && entry.details.fileDetails && (
                          <>
                            ...
                            {entry.details.fileDetails.fileId && (
                              <div className={styles.detailRow}>
                                <span className={styles.detailLabel}>{entry.action === 'pdf-generate' ? 'Source File ID:' : 'Image File ID:'}</span>
                                <span className={styles.detailValue}>{entry.details.fileDetails.fileId}</span>
                              </div>
                            )}
