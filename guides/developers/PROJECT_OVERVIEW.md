...
Striae is currently in **Beta** (v0.9.22a) with active development featuring enhanced export security and comprehensive case review import system. The case import functionality enables secure collaboration through ZIP package import with automatic read-only protection. The release candidate is expected to deploy on October 1, 2025. The project is actively maintained and welcomes contributions from the forensic technology community.
